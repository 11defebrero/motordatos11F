...
Las actividades que organizan los centros educativos las puedes consultar en [Centros11F](https://11defebrero.github.io/web11F/centros11f_todos.html)
...
actividades <- get_actividades_limpio(file_id=params$id_sheet, ed <- params$edicion) %>%
