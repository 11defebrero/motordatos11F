---
pagetitle: "Solicitudes - videollamada"
params:
  id_sheet: NA
output: 
  html_document: 
...
# Solicitud de charlas por VIDEOLLAMADA en centros educativos

Estos centros están dispuestos a recibir **charlas por videollamada** (vía Skype, Hangouts, etc) por lo que puedes participar dando una charla **desde cualquier lugar del mundo**, sin tener que desplazarte hasta el centro educativo.
...
### Mapa de charlas por videollamada solicitadas
...
### Tabla de charlas por videollamada solicitadas
